...
- `OPEN_DIRECT_CONVERSATION_REQ / RESP`
- `LIST_DIRECT_CONVERSATIONS_REQ / RESP`
- `SEND_DIRECT_MESSAGE_REQ / ACK`
- `DIRECT_MESSAGE_EVENT`
- `ACK_DIRECT_MESSAGE_REQ / RESP`
- `DIRECT_PEER_ACK_EVENT`
- `SYNC_DIRECT_MESSAGES_REQ / RESP`
